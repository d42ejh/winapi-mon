...
pub static PeekMessageADetour: SyncOnceCell<Arc<RwLock<GenericDetour<FnPeekMessageA>>>> =
    SyncOnceCell::new();
pub static PeekMessageWDetour: SyncOnceCell<Arc<RwLock<GenericDetour<FnPeekMessageW>>>> =
    SyncOnceCell::new();
