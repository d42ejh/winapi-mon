...
pub static SendMessageADetour: SyncOnceCell<Arc<RwLock<GenericDetour<FnSendMessageA>>>> =
    SyncOnceCell::new();
pub static SendMessageWDetour: SyncOnceCell<Arc<RwLock<GenericDetour<FnSendMessageA>>>> =
    SyncOnceCell::new();
